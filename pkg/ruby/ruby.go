...
type Options struct {
	// RubyVersion is the version of Ruby to search for within the cvedb
	...
	// Path is the path to the cvedb directory or a single package to check
	Path string
...
var rubyCacheDirectory = path.Join(xdg.CacheHome, "cvectl", "ruby")
