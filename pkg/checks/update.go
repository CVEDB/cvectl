...
import (
	...
	version "github.com/cvedb/cvectl/pkg/versions"
	...
	"github.com/cvedb/cvectl/pkg/lint"
...
// SetupUpdate will create the options needed to call cvectl update functions
func SetupUpdate(ctx context.Context) (*update.Options, lint.EvalRuleErrors) {
	...
	o.Logger = log.New(log.Writer(), "cvectl check update: ", log.LstdFlags|log.Lmsgprefix)
