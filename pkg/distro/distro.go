...
// Distro represents a cvectl-compatible distro, along with important
...
type AbsoluteProperties struct {
	// The Name of the distro, e.g. "Cvedb".
	Name string
...
var (
	cvedbDistro = AbsoluteProperties{
		Name:                 "Cvedb",
		DistroRepoOwner:      "cvedb",
		DistroPackagesRepo:   "os",
		DistroAdvisoriesRepo: "advisories",
		APKRepositoryURL:     "https://packages.cvedb.dev/os",
		SupportedArchitectures: []string{
			"x86_64",
			"aarch64",
		},
