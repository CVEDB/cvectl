...
func TestDetect(t *testing.T) {
	...
	repos := []struct {
		...
		},
		{
			name: "my-advisories",
			remoteURLs: []string{
				"git@github.com:cvedb/advisories.git",
			},
		},
	}
	...
	assert.Equal(t, "Cvedb", d.Absolute.Name)
	...
	assert.Equal(t, "https://packages.cvedb.dev/os", d.Absolute.APKRepositoryURL)
}
