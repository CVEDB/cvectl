...
import (
	...
	"github.com/cvedb/cvectl/pkg/sbom"
...
func cmdSBOM() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// TODO: Bring input retrieval options in line with `cvectl scan`.
...
func (p *sbomParams) addFlagsTo(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&p.distro, "distro", "cvedb", "distro to report in SBOM")
