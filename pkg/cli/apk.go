...
import (
	...
	"github.com/cvedb/cvectl/pkg/index"
)

var repos = map[string]string{
	"cvedb":  "https://packages.cvedb.dev/os",
	"stage1": "https://packages.cvedb.dev/bootstrap/stage1",
	"stage2": "https://packages.cvedb.dev/bootstrap/stage2",
	"stage3": "https://packages.cvedb.dev/bootstrap/stage3",
}
...
func cmdApk() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Map a friendly string like "cvedb" to its repo URL.
	...
	cmd.Flags().StringVar(&repo, "repo", "cvedb", "repo to get packages from")
	return cmd
}
