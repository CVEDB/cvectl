...
func SoName() *cobra.Command {
	...
	cmd.Flags().StringVarP(&o.ApkIndexURL, "apk-index-url", "", "https://packages.cvedb.dev/os/aarch64/APKINDEX.tar.gz", "apk-index-url used to get existing apks.  Defaults to cvedb")
