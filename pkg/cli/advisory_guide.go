...
import (
	...
	"github.com/cvedb/cvectl/pkg/cli/components/ctrlcwrapper"
	"github.com/cvedb/cvectl/pkg/cli/components/interview"
	"github.com/cvedb/cvectl/pkg/cli/components/keytocontinue"
	"github.com/cvedb/cvectl/pkg/cli/components/picker"
	"github.com/cvedb/cvectl/pkg/cli/internal/builds"
	"github.com/cvedb/cvectl/pkg/cli/internal/wrapped"
	"github.com/cvedb/cvectl/pkg/cli/styles"
	v2 "github.com/cvedb/cvectl/pkg/configs/advisory/v2"
	"github.com/cvedb/cvectl/pkg/distro"
	question2 "github.com/cvedb/cvectl/pkg/question"
	"github.com/cvedb/cvectl/pkg/scan"
	"github.com/cvedb/cvectl/pkg/vuln"
)
...
This is cvectl's interactive guide for advisory data entry.
...
Or, if this directory %s your clone of the distro repo, then please go yell at the cvectl maintainers and demand some answers!
`
)
