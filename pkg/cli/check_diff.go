...
func Diff() *cobra.Command {
	...
	cmd.Flags().StringVarP(&apkIndexURL, "apk-index-url", "", "https://packages.cvedb.dev/os/%s/APKINDEX.tar.gz", "apk-index-url used to get existing apks.  Defaults to cvedb")
