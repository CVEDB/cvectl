				...
				Errors: EvalRuleErrors{
					{
						...
						Error: fmt.Errorf("[forbidden-repository-used]: forbidden repository https://packages.cvedb.dev/os is used (ERROR)"),
					},
				},
			},
			wantErr: false,
				...
				Errors: EvalRuleErrors{
					{
						...
						Error: fmt.Errorf("[forbidden-keyring-used]: forbidden keyring https://packages.cvedb.dev/os/cvedb-signing.rsa.pub is used (ERROR)"),
					},
				},
			},
			wantErr: false,
